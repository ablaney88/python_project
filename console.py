...
manufacturer2 = Manufacturer("Telchar", "Elven smith", "First Age")
manufacturer_repository.save(manufacturer2)

manufacturer_repository.select_all()

weapon1 = Weapon("Boltgun", "Big gun kills xenos", "35kg", "Steel", 300, 500, manufacturer1)
weapon_repository.save(weapon1)

weapon2 = Weapon("Nasir", "Sauron's worst nightmare", "2kg", "Steel", 1000, 3000, manufacturer2)
