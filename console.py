...
manufacturer4 = Manufacturer("Vulkan", "Producer of arms for the Astartes", "M25")
manufacturer_repository.save(manufacturer4)

manufacturer5 = Manufacturer("Sanguinius", "Producer of arms for the Astartes", "M25")
...
weapon4 = Weapon("Thunder Hammer", manufacturer1, "Hammer go smash", 150, "Steel", 1500, 4000, 10)
weapon_repository.save(weapon4)

weapon5 = Weapon("Plasma Pistol", manufacturer1, "Melt your enemies", 6, "Steel", 800, 1400, 25)
